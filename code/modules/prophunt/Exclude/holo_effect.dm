/*
	The prophunt activates these shortly after the program loads,
	and deactivates them immediately before changing or disabling the prophunt.

	These remove snowflake code for special prophunt functions.
*/
...
/obj/effect/holodeck_effect/proc/activate(var/obj/machinery/computer/prophunt/HC)
	return

/obj/effect/holodeck_effect/proc/deactivate(var/obj/machinery/computer/prophunt/HC)
	qdel(src)
	return

// Called by the prophunt computer as long as the program is running
/obj/effect/holodeck_effect/proc/tick(var/obj/machinery/computer/prophunt/HC)
	return
...
// Generates a prophunt-tracked card deck
/obj/effect/holodeck_effect/cards
	icon = 'icons/obj/toy.dmi'
	icon_state = "deck_nanotrasen_full"
	var/obj/item/toy/cards/deck/D

/obj/effect/holodeck_effect/cards/activate(var/obj/machinery/computer/prophunt/HC)
	D = new(loc)
...
/obj/effect/holodeck_effect/sparks/activate(var/obj/machinery/computer/prophunt/HC)
...
/obj/effect/holodeck_effect/mobspawner/activate(var/obj/machinery/computer/prophunt/HC)
	if(islist(mobtype))
...
/obj/effect/holodeck_effect/mobspawner/deactivate(var/obj/machinery/computer/prophunt/HC)
	if(mob)
		HC.derez(mob)
	qdel(src)
