...
/obj/machinery/conveyor/prophunt

/obj/machinery/conveyor/prophunt/attackby(obj/item/I, mob/user, params)
	if(!user.transferItemToLoc(I, drop_location()))
		return ..()

/obj/item/paper/fluff/prophunt/trek_diploma
	name = "paper - Starfleet Academy Diploma"
	info = {"<h2>Starfleet Academy</h2></br><p>Official Diploma</p></br>"}

/obj/item/paper/fluff/prophunt/disclaimer
	name = "Holodeck Disclaimer"
	info = "Bruises sustained in the prophunt can be healed simply by sleeping."
