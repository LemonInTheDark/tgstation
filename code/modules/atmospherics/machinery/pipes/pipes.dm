...
/obj/machinery/atmospherics/pipe/Initialize(mapload)
	...
	if(hide)
		AddElement(/datum/element/undertile, _bespoke_element_key = TRAIT_T_RAY_VISIBLE, TRAIT_T_RAY_VISIBLE) //if changing this, change the subtypes RemoveElements too, because thats how bespoke works
