...
/datum/supply_pack/emergency/ghost_prevention_kit
	...
	desc = "Trap the souls of the long dead in cages, hunt them down and stop their mad rampage of mild annoyance with the WF INC brand Supernatural Value Pack"
	cost = 1000
	access = ACCESS_CARGO
