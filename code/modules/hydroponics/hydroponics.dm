...
/obj/item/circuit_component/hydroponics/unregister_usb_parent(atom/movable/parent)
	attached_tray = null
	UnregisterSignals(parent, list(COMSIG_HYDROTRAY_SET_SEED, COMSIG_HYDROTRAY_SET_SELFSUSTAINING,
	...
	if(parent.reagents)
		UnregisterSignals(parent.reagents, list(COMSIG_REAGENTS_ADD_REAGENT, COMSIG_REAGENTS_REM_REAGENT,
