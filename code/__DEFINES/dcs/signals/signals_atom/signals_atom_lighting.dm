...
///Called when an atom's light_overlay datum applies visuals, from base of [/datum/light_overlay/proc/show_to_holder]: (image/mask, image/cone, atom/movable/light_holder)
...
///Called when an atom's light_overlay datum hides its visuals, from base of [/datum/light_overlay/proc/hide_from_holder]: (atom/movable/light_holder)
...
///Called when a light_overlay datum has its holder changed, from base of [/datum/light_overlay/proc/set_holder] : (atom/movable/old_holder, atom/movable/new_holder)
#define COMSIG_LIGHT_OVERLAY_UPDATE_HOLDER "light_overlay_update_holder"
